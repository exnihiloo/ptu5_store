    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', models.CharField(blank=True, max_length=12, verbose_name='post code')),
                ('address_line_1', models.CharField(blank=True, max_length=150, verbose_name='adress 1')),
                ('address_line_2', models.CharField(blank=True, max_length=150, verbose_name='adress 2')),
